...
class BadVC: UIViewController {
    ...
    var firstViewController : Bad1VC! = nil
    var secondViewController : Bad2VC! = nil
    ...
    fileprivate func firstBuilder() {
        if firstViewController == nil {
            firstViewController =
                storyboard?
                .instantiateViewController(withIdentifier: "BadSetup")
            as! Bad1VC
        }
    }
    ...
    fileprivate func secondBuilder() {
        if secondViewController == nil {
            secondViewController =
                storyboard?
                .instantiateViewController(withIdentifier: "BadPunchline")
            as! Bad2VC
        }
    }
